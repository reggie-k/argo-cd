...
import {services, ViewPreferences, AppSetViewPreferences} from '../shared/services';
import { isAppSet, isFromAppSetComponents } from '../applications/components/utils';
...
export const APPSET_SIDEBAR_TOOLS_ID_NAME = isFromAppSetComponents() ? APPSET_SIDEBAR_TOOLS_ID : SIDEBAR_TOOLS_ID

export const useSidebarTarget = () => {
    const sidebarTarget = React.useRef(document.createElement('div'));

    React.useEffect(() => {
        const sidebar = isFromAppSetComponents() ? document.getElementById(APPSET_SIDEBAR_TOOLS_ID): document.getElementById(SIDEBAR_TOOLS_ID);
...
export const Sidebar = (props: AbstractSidebarProps) => {
    ...
    return (
        <div className={`sidebar ${props.pref.hideSidebar ? 'sidebar--collapsed' : ''}`}>
            ...
            <div id={APPSET_SIDEBAR_TOOLS_ID_NAME} />
        </div>
    );
};
