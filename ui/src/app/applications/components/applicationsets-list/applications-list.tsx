...
function loadApplicationSets(appNamespace: string): Observable<models.ApplicationSet[]> {
    return from(services.applicationSets.list({appNamespace, fields: APPSET_LIST_FIELDS})).pipe(
