...
export const ApplicationTiles = ({ applications, syncApplication, refreshApplication, deleteApplication }: ApplicationTilesProps) => {
    ...
    useKeybinding({
        ...
        action: () => {
            if (selectedApp > -1) {
                ctxh.navigation.goto(`${AppUtils.getRootPath(applications[selectedApp])}${applications[selectedApp].metadata.name}`);
                return true;
            }
            return false;
        }
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div className={`columns small-12 applications-list__info qe-applications-list-${AppUtils.appInstanceName(app)}`}>
                                                        ...
                                                        {source.path && !AppUtils.isAppSet(app) && (
                                                            <div className='row'>
                                                        ...
                                                        {source.chart && !AppUtils.isAppSet(app) && (
                                                            <div className='row'>
