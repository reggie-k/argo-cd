...
export const ApplicationTiles = (tilesProps: AbstractApplicationTilesProps) => {
    ...
    useKeybinding({
        ...
        action: () => {
            if (selectedApp > -1) {
                const isApp = tilesProps.applications[selectedApp].kind === 'Application';
                console.log("$$$$$$$$$$$$$$$$ " + isApp + ", " + tilesProps.applications[selectedApp].kind )
                ctxh.navigation.goto(`${AppUtils.getRootPath(isApp)}/${tilesProps.applications[selectedApp].metadata.name}`);
                                        ...
                                        <div key={AppUtils.appInstanceName(app)} className='column column-block'>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    onClick={e =>
                                                        ctx.navigation.goto(
                                                            `${AppUtils.getRootPath(isApp(app))}/${app.metadata.namespace}/${app.metadata.name}`,
