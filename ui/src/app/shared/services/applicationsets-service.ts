...
export class ApplicationSetsService {
    ...
    public updateSpec(appName: string, appNamespace: string, spec: models.ApplicationSetSpec): Promise<models.ApplicationSetSpec> {
        return requests
    ...
    public create(app: models.ApplicationSet): Promise<models.ApplicationSet> {
